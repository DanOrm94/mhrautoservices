...
async function buildPdf(env: Env, invoiceNumber: string, body: Required<Pick<InvoiceBody,'customer_name'|'vehicle'|'job_description'>> & InvoiceBody, total: number, vatAmount: number, subtotal: number) {
